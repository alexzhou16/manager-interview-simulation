...
let messages = [
   ...
   { from: 'Tom', text: 'Hi Mary. Thanks for attending this interview today for the position of Director of Sales at Worldwide Inc. This will be a brief conversation to get to know you, learn about your experience, and see if you are a good fit for the role. If today goes well, you will have a longer interview with my [team or supervisor]. Sound good?', sender: 'tom' },
